...
<%@page import="entity.Post" %>
		...
		<%
			...
			Post p=new Post();
			p=postdata.getPostByPostId(postId);
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
	<ul class="navbar-nav mr-auto">
		<li class="nav-item active"><a class="nav-link" href="profile.jsp"><span><i
		...
		<li class="nav-item dropdown"><a
			...
			<div class="dropdown-menu">
				...
				%>
				<a class="dropdown-item" href="#" onclick="getPosts(<%=cc.getCid()%>)"><%=cc.getName()%></a>
				<%
				}
				%>
			</div></li>
...
<div class="row  m-4">
  <div class="col-sm-7">
    <div class="card">
      <div class="card-body">
    	<img src="blog_pic/<%=p.getpPic()%>" class="card-img " >	       
      </div>
      <div class="card-footer">
      	<%
      	UserData userdata=new UserData(ConnectionProvider.getConnection());
    	%>
      	<label>Posted By:   <a href="#" style="text-decoration: none;"><%=userdata.getUserByUserId(p.getUserId()).getName() %></a></label>
      </div>
    </div>
  </div>
  <div class="col-sm-5">
...
<%
 ...
 %>
	...
	<label> Date Modified: <%=p.getpDate().toLocaleString() %></label>
	</div>
    </div>
  </div>
</div>
